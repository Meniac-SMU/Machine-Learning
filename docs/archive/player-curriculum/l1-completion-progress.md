...
Historical r001-r009 log. Current r010+ work is tracked only in [current status](../../soccer/current-status.md); the [staged reward plan](staged-reward-plan.md) supersedes the old reward-based promotion assumptions below.
